...
<script src="./__GROUP__/js/Validform_v5.3.2_min.js"></script>
<style type="text/css">
	#email-goto{top:13px;}
		...
		<div class="col-md-8">
		    ...
		    <form method="post" action="/" id="reg-form">
		    		...
		    		<div class="form-group">
		    			...
		    			<input id="repasswd" type="password" name="repasswd" recheck="passwd" errormsg="两次密码不一致" class="form-control" placeholder="再次输入密码" />
		    		</div>
