...
-->
         ...
         <?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$address): $mod = ($i % 2 );++$i;?><li class="my-options"><a href="<?php echo ($now_url_address); ?>&address=<?php echo ($address["aid"]); ?>" class=""><?php echo ($address["area"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <ul class="list-options">
                                <li><a href="<?php echo ($now_url_wt); ?>&wt=min:1">1小时以下</a></li>
                                <li><a href="<?php echo ($now_url_wt); ?>&wt=2:6">2-6小时</a></li>
                                <li><a href="<?php echo ($now_url_wt); ?>&wt=6:max">一天以上</a></li>
                            </ul>
                            </li>
                            <li class="list-group-item">
                ...
                <div class="panel panel-default">
                    <ul class="list-group">
                        <?php if($error_info): ?><li class="list-group-item"><?php echo ($error_info); ?></li>
                        <?php else: ?>
                        
                        <?php if(is_array($job_list)): $i = 0; $__LIST__ = $job_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$job): $mod = ($i % 2 );++$i;?><li class="list-group-item"><?php echo ($job["title"]); ?></li><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                    </ul>
                    <nav>
                        <ul class="pagination">
                        <?php echo ($page); ?>
