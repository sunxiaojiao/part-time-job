    ...
    -->
      <form method="post" action="" id="edit-info">
        <div class="form-group">
          ...
          <input type="text" id="username" name="username" class="form-control" placeholder="填写用户名" />
        </div>
        <div class="form-group">
          <label>性别：</label>
        ...
        <div class="form-group">
          ...
          <input type="text" id="age" name="age" class="form-control" placeholder="填写年龄" />
        </div>
        <div class="form-group">
          ...
          <div class="my-select-address">
            ...
            <select name="area" id="" class="form-control">
              <option value="">芝罘区</option>
            </select>
          </div>
        </div>
        <div class="form-group">
          <label for="school">学校：</label>
          <input type="text" id="school" name="school" class="form-control" placeholder="填写所在学校" />
        </div>
        <div class="form-group">
          <label for="phone">联系电话：</label>
          <input type="text" id="phone" name="phone" class="form-control" placeholder="填写联系电话" />
        </div>
        <div class="form-group">
          <label for="email">邮箱：</label>
          <input type="text" id="email" name="email" class="form-control" placeholder="填写个人邮箱" />
        </div>
        <div class="form-group">
          <label for="qq">QQ：</label>
          <input type="text" id="qq" name="qq" class="form-control" placeholder="填写联系QQ" />
        </div>
          <div class="form-group">
            <label for="exp">基本介绍和工作经验:</label>
            <textarea class="form-control" rows="3" id="exp" name="exp" placeholder="填写个人的简介和工作经验"></textarea>
          </div>
        <div class="form-group">
          <label for="intent">求职意向:</label>
          <div>
            <label class="checkbox-inline">
              <input type="checkbox" id="" name="intent" value="1">程序员
            </label>
            <label class="checkbox-inline">
