            ...
            <div class="col-md-9">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="well col-md-3">今日新增用户：&emsp;<?php echo ($userToday); ?></div>
                        <div class="well col-md-3">总用户：&emsp;<?php echo ($userTotal); ?></div>
                        <div class="well col-md-3">今日新增企业用户：&emsp;<?php echo ($orgToday); ?></div>
                        <div class="well col-md-3">总企业用户：&emsp;<?php echo ($orgTotal); ?></div>
                    </div>
                </div>
            </div>
        </div>
